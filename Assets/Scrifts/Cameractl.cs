...
public class Cameractl : MonoBehaviour
{
    ...
    void Move_Player()
    {
        //transform.position=new Vector3(0, 8.3f,player.position.z - 9.3f);
        transform.position = Vector3.Lerp(transform.position, new Vector3(0, 8.3f, player.position.z - 9.3f), 2 * Time.deltaTime); /*new Vector3(0, 8.3f,player.position.z  -9.3f);*/
